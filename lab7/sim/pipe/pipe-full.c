...
long long gen_f_pc()
{
    return (((((ex_mem_curr->icode) == (I_JMP)) & !
          (ex_mem_curr->takebranch)) & ((ex_mem_curr->vale) == 0)) ? 
      (ex_mem_curr->vala) : ((((ex_mem_curr->icode) == (I_JMP)) & 
          (ex_mem_curr->takebranch)) & ((ex_mem_curr->vale) == 1)) ? 
...
{
    return ((((((if_id_next->icode) == (I_JMP)) & ((id_ex_curr->icode) == 
              (I_RMMOVQ))) & ((id_ex_curr->vala) > 0)) & (
          (if_id_curr->icode) == (I_ALU))) ? (if_id_next->valp) : (
        (if_id_next->icode) == (I_CALL) || (if_id_next->icode) == (I_JMP))
...
{
    return (((((if_id_curr->icode) == (I_JMP)) & ((ex_mem_curr->icode) == 
            (I_RMMOVQ))) & ((ex_mem_curr->vala) > 0)) ? 1 : (
        (if_id_curr->icode) == (I_JMP)) ? 0 : ((id_ex_next->srcb) == 
...
long long gen_aluA()
{
    return (((id_ex_curr->icode) == (I_JMP)) ? 0 : ((id_ex_curr->icode) == 
        (I_RRMOVQ) || (id_ex_curr->icode) == (I_ALU)) ? (id_ex_curr->vala)
...
long long gen_aluB()
{
    return (((id_ex_curr->icode) == (I_RMMOVQ) || (id_ex_curr->icode) == 
        ...
        (I_JMP)) ? (id_ex_curr->valb) : ((id_ex_curr->icode) == (I_RRMOVQ)
...
{
    return ((((id_ex_curr->icode) == (I_JMP)) & ((id_ex_curr->valb) == 1))
...
long long gen_D_bubble()
{
    return ((((((id_ex_curr->icode) == (I_JMP)) & !
            (ex_mem_next->takebranch)) & ((id_ex_curr->valb) == 0)) | (((
              (id_ex_curr->icode) == (I_JMP)) & (ex_mem_next->takebranch))
           & ((id_ex_curr->valb) == 1))) | (!(((id_ex_curr->icode) == 
